...
export default function ContaAzul() {
	function handleRedirectToContaAzul() {
		...
		const authUrl = `https://auth.contaazul.com/oauth2/authorize?response_type=code&client_id=${clientId}&redirect_uri=${encodeURIComponent(redirectUri)}&state=ESTADO&scope=openid+profile+aws.cognito.signin.user.admin`
